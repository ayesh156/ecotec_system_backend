...
// setHeaderClean() removes any existing value for a header before setting it,
// so this middleware can NEVER emit a duplicate value for a given header no
// matter how many times it (or anything else touching the response) fires.
